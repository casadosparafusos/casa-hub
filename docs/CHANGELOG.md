...
- **não mergeado, não deployado, nenhuma migration aplicada em produção, nenhuma escrita real em Wake/CISS, nenhum PR novo, nenhum force-push, não marcado como pronto para review — FASE D real de rollout continua BLOCKED por SSH/credenciais**.
